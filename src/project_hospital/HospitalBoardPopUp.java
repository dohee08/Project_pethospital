...
public class HospitalBoardPopUp extends JFrame {
 
    JTextField title;
    JTextField writer;
 
    public HospitalBoardPopUp(UserVO vo) {
        ...
        title = new JTextField(vo.getPtitle());
        ...
        JTextArea textArea = new JTextArea(vo.getPtext());
        ...
        writer = new JTextField(vo.getPname());
