...
public class UserVO {
	String mid, mpass, mphone, mname, mkind; //Member
	
	String hno, hsymptom, hyear, hmonth, hday, htime; //hbooking
	
	String sno, syear, smonth, sday, stime, sgender, stext; //SALONRES
